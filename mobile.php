                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        filterOptions.forEach(option => {
                            option.addEventListener("click", function() {
                                ...
                                // Lưu trữ các bộ lọc đã chọn vào object filters
                                filters[filterType] = value;
                            });
                        });

                        document.getElementById("applyFiltersButton").addEventListener("click", function() {
                            // Chuyển các giá trị đã chọn thành query string
                            let queryString = "?cartegory_id=1";
                            ...
                            // Chuyển hướng trang với query string
                            window.location.replace("<?php echo _WEB_HOST_1 ?>/filter-product.php" + queryString);
                        });
                    });
                </script> -->

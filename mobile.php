...
<body>
    ...
    <div class="mobile-container">
        <ul class="nav-list">
            ...
            <li><a href="<?php echo _WEB_HOST_1 ?>/mobile.php" ><i class="fa-solid fa-greater-than" style="font-size: 12px;"></i>Điện
                    thoại</a>
            </li>
        </ul>
        <div class="clear"></div>
        ...
        <div class="list-brand">
            <nav>
                ...
                ?>
                            <a href="<?php echo _WEB_HOST_1 ?>/apple.php?brand_id=<?php echo $item['id'] ?>"  class="list-brand_item"><span><?php echo $item['name'] ?></span> </a>
